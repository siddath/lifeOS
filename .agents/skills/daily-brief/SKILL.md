...
This skill can run on a schedule (e.g., a morning trigger / `loop`) to push the brief automatically. See `docs/` if present, or set up a Routine via the Codex remote tools.
